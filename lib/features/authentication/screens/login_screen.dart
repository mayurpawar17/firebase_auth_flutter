import 'package:firebase_auth_flutter/features/authentication/screens/register_screen.dart';
        ...
        listener: (context, state) {
          if (state is AuthSuccessState) {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                // builder: (context) => HomeScreen(email: state.message),
                    ...
                    children: [
                      ...
                      CustomTextField(
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon:
                              state is ObscureButtonState && !state.isObscure
